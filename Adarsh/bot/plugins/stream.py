...
async def private_receive_handler(c: Client, m: Message):
    ...
    try:
        ...
        stream_link = f"https://lazadeal.com/watch/{str(log_msg.id)}/{quote_plus(get_name(log_msg))}?hash={get_hash(log_msg)}"
        
        online_link = f"https://lazadeal.com/{str(log_msg.id)}/{quote_plus(get_name(log_msg))}?hash={get_hash(log_msg)}"
        
        photo_xr="https://telegra.ph/file/b9e78db647e3ab01b0753.png"
        
        

        msg_text ="""
<b>FILE CUA BAN DA SAN SANG...⚡

<b>📧 FILE NAME :- </b> <i><b>{}</b></i>

<b>📦 FILE SIZE :- </b> <i><b>{}</b></i>

<b>💌 LINK DOWNLOAD :- </b> <i><b>{}</b></i>
...
<b>♻️ LINK DOWNLOAD KHONG BAO GIO HET HAN ! ♻️\n\n❖ Https://muabanquyen.com</b>"""
        ...
        await m.reply_text(
            ...
            quote=True,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("⚡ XEM ONLINE ⚡", url=stream_link), #Stream Link
