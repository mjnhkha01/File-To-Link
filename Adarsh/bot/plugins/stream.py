...
async def private_receive_handler(c: Client, m: Message):
    ...
    try:
        ...
        stream_link = f"http://lazadeal.com/watch/{str(log_msg.id)}/{quote_plus(get_name(log_msg))}?hash={get_hash(log_msg)}"
        
        online_link = f"http://lazadeal.com/{str(log_msg.id)}/{quote_plus(get_name(log_msg))}?hash={get_hash(log_msg)}"
